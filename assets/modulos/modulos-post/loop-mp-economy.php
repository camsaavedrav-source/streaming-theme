...
<article class="md:col-span-8 group cursor-pointer">
    <div class="relative w-full h-[500px] overflow-hidden rounded mb-4">
        ...
        <span class="font-label-sm text-label-sm text-primary uppercase"><?php $categories_list = get_the_category_list( esc_html__( ', ', 'blogtarea4' ) ); 
    ...
    <span> <?php blogtarea4_posted_by(); ?> </span>
    <span>•</span>
    <span> <?php blogtarea4_posted_on(); ?> </span>
    </div>
</article>
